...
mainly the coding was not so difficult because we actually learnt these languages back in 10th grade(Though I didn't use them very much). Also for physics... I used
 ...
 # Streamlit Version (Coded in Python) is also available!
